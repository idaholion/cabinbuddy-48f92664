    ...
    <div className="min-h-screen bg-cover bg-center bg-no-repeat p-4" style={{
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-start gap-8">
          {/* Title Section - aligned with card top */}
          <div className="flex-1">
            <Button variant="outline" asChild className="mb-4">
              <Link to="/setup">← Back to Setup</Link>
            </Button>
            <h1 className="text-6xl mb-4 font-kaushan text-primary drop-shadow-lg">Family Group Setup</h1>
              ...
              <CardContent className="space-y-6 py-2">
                <Form {...form}>
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                                ...
                                <div className="p-3 bg-muted/30 rounded border">
                                  ...
                                  {isEditingName ? (
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                      Click rename to change this family group's name
                                    </p>
                                  )}
                                </div>
                              )}
                    ...
                    {/* Family Group Lead Information */}
                    {watchedData.selectedGroup && watchedData.selectedGroup !== "no-groups" && (
                      <div className="space-y-6">
                        <div className="text-center">
                          <h3 className="text-xl font-semibold mb-2">Family Group Lead Information</h3>
                          <p className="text-muted-foreground">The primary contact person for this family group</p>
                        </div>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="Enter lead email address" {...field} />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>Alternate Group Lead</FormLabel>
                              <p className="text-sm text-muted-foreground mb-2">
                                Select an alternate lead who can act as the group lead when the primary lead is unavailable.
                              </p>
                              <FormControl>
                                <RadioGroup
                                  value={field.value}
                                ...
                                >
                                  <div className="flex items-center space-x-2">
                                    ...
                                    <label htmlFor="none" className="text-sm">None selected</label>
                                  </div>
                                  {watchedData.hostMembers?.filter(member => member.name?.trim()).map((member, index) => (
                                    <div key={index} className="flex items-center space-x-2">
                                      <RadioGroupItem value={index.toString()} id={`member-${index}`} />
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center justify-between">
                            <div>
                              <h3 className="text-xl font-semibold">Host Members</h3>
                              <p className="text-muted-foreground">Family members who can book and manage reservations</p>
                              <p className="text-xs text-muted-foreground mt-1">
                                Filled slots: {filledMembersCount} • Total slots: {fields.length}
                              </p>
                            </div>
                            <div className="flex flex-wrap gap-2">
                              {fields.length > 3 && (
                                ...
                                >
                                  {showAllMembers ? 'Show Less' : `Show All (${fields.length})`}
                                </Button>
                              )}
                              <Button
                                type="button"
                                ...
                                <AlertDialogContent>
                                  <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                      This will remove all host member information and reset to 3 empty slots. This action cannot be undone.
                                    </AlertDialogDescription>
                                  </AlertDialogHeader>
                                  <AlertDialogFooter>
                                    <AlertDialogCancel>Cancel</AlertDialogCancel>
                                    <AlertDialogAction onClick={clearAllHostMembers} className="bg-destructive text-destructive-foreground hover:bg-destructive/90">
                                      Clear All
                                    </AlertDialogAction>
                                  </AlertDialogFooter>
                                </AlertDialogContent>
                          ...
                          >
                            <SortableContext 
                              items={displayedMembers.map(field => `host-member-${field.id}`)}
