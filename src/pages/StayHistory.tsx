  ...
  return (
    <div className="container mx-auto p-6 space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        ...
        {totalCreditApplied > 0.004 && (
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Credit Carried In &amp; Applied</CardTitle>
              <Wallet className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-green-600 dark:text-green-400">+${totalCreditApplied.toFixed(2)}</div>
              <p className="text-xs text-muted-foreground mt-1">
                Left over from earlier stays and used against the stays shown
              </p>
            </CardContent>
          </Card>
        )}
