...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const selectionDays = isSecondaryPhase ? 7 : 14;
    const selectionWeeks = isSecondaryPhase ? '1 week' : '2 weeks';
    const maxPeriods = isSecondaryPhase ? '1 period' : 'up to 2 periods';
